    ...
    <Popover>
      ...
      <PopoverContent align="end" className="w-64 p-2 bg-white dark:bg-[#0f1a0f] border border-green-100 dark:border-[#166534]">
        ...
        <form action={logoutAction}>
          <button type="submit" className="w-full flex items-center gap-2 px-2 py-1.5 text-sm text-green-700 dark:text-[#86efac] hover:bg-green-50 dark:hover:bg-[#1a2e1a] rounded">
